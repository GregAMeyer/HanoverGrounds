...
var seedProducts = function () {
    ...
    var products = [
        {name: "Metropolis Coffee", company: "Hipster Coffee Comp", description: "This unique cognac-like blend balances delicacy and elegance, with jasmine and orange notes giving way to buttery shortbread, and a mild caramel that ties it all together. A light and refreshing spring and summer brew with subtle yet astonishing nuances.", price: 15.30, photo: "metropolis.jpg", rating: 3, category: "Coffee", roast: "Medium", region: "Africa", reviews: [{userId: 234233, review: "delicious!"}, {userId: 2909, review: "horrible! worst. coffee. ever. BLAH."}]},
